...
private:
	...
	/// @property(name="Bevel emboss", tooltip="Off = radial gradient from lights; On = volumetric height-field lighting")
	...
	/// @property(minValue=0.f, maxValue=1.f, dragSpeed=0.01f, tooltip="0 = glossy specular, 1 = matte diffuse")
